...
- UI, clavier, focus, layout, buffers : `npm run test:pilot-ui` (fenêtre cachée, ne vole jamais le focus de l’écran ; `MEDIAGEN_PILOT_UI_SHOW=1` pour la voir en débogage) ;
