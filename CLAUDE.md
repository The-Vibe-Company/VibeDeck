...
3. Ajouter une seule définition au tableau `entries` du registre : identité, langue/groupe, catégorie éditoriale (`general`, `local`, `business`, `sports` ou `culture`), rang, page d’accueil, domaines exacts, flux, intervalle et éventuelles exceptions de lecteur ou d’enrichissement.
